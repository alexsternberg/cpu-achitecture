...
lpcusblib/Drivers/USB/Core/HCD/OHCI/%.o: ../lpcusblib/Drivers/USB/Core/HCD/OHCI/%.c
	...
	arm-none-eabi-gcc -std=gnu99 -D__REDLIB__ -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -D__LPC175X_6X__ -DUSB_HOST_ONLY -DCORE_M3 -I"C:\Users\nykos\src\cpu-achitecture\examples\lpc_chip_175x_6x\inc" -I"C:\Users\nykos\src\cpu-achitecture\examples\lpc_board_nxp_lpcxpresso_1769\inc" -I"C:\Users\nykos\src\cpu-achitecture\examples\lpcusblib_MassStorageHost\example\inc" -I"C:\Users\nykos\src\cpu-achitecture\examples\lpcusblib_MassStorageHost\lpcusblib\Drivers\USB" -I"C:\Users\nykos\src\cpu-achitecture\examples\lpcusblib_MassStorageHost\fatfs\inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
