...
lwip/src/arch/%.o: ../lwip/src/arch/%.c
	...
	arm-none-eabi-gcc -D__REDLIB__ -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -DCORE_M3 -I"C:\Users\nykos\src\cpu-achitecture\examples\lpc_chip_175x_6x\inc" -I"C:\Users\nykos\src\cpu-achitecture\examples\lpc_board_nxp_lpcxpresso_1769\inc" -I"C:\Users\nykos\src\cpu-achitecture\examples\iperf_server\example\inc" -I"C:\Users\nykos\src\cpu-achitecture\examples\iperf_server\lwip\inc" -I"C:\Users\nykos\src\cpu-achitecture\examples\iperf_server\lwip\inc\ipv4" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
